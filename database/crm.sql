...
INSERT INTO `django_admin_log` VALUES (1,'2021-11-21 22:14:51.679764','1','Abdullah Aladham',1,'[{\"added\": {}}]',10,1);
...
DROP TABLE IF EXISTS `membership_membership`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `membership_membership` WRITE;
/*!40000 ALTER TABLE `membership_membership` DISABLE KEYS */;
/*!40000 ALTER TABLE `membership_membership` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-22 13:25:00
